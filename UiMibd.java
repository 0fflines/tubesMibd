    ...
    public class UiMibd {
        ...
        public static void printLoginPage() {
            ...
            System.out.println("Selemat datang pada sRusun, silakan masukan nomor telepon yang sudah didaftar untuk login");
            System.out.print("No.Telp: ");
            String emailInput = sc.next();
            System.out.println();
            System.out.println("OTP telah dikirm kepada nomor telepon yang sudah dimasukan, tolong masukan OTP yang diterima");
            System.out.print("OTP: ");
            String otpInput = sc.next();
            System.out.println();

            if(otpInput.equals("1")) printHomePageAdmin();
            else printHomePageUser();
        }

        public static void printHomePageAdmin() {
            printAsciiBox(logo);
        ...
        public static void printHomePageUser() {
            printAsciiBox(logo);
            System.out.println("Selamat datang pada homepage\n");
            System.out.println("Silahkan pilih menu dibawah ini:");
            System.out.println("1) Melihat laporan pemakaian air");
        ...
        public static void printLaporanAirAdmin() {
            printAsciiBox(logo);
            displaySarusun(0);
        ...
        public static void printLogDownload() {
            printAsciiBox(logo);
            System.out.println("Ketik '.' jika ingin kembali ke homepage");
            System.out.println("Masukkan NIK untuk melihat log user tersebut atau # untuk melihat log semua user");
        ...
        public static void printLaporanAirUser() {
            printAsciiBox(logo);
            displaySarusun(0);
            System.out.println("Ketik '.' jika ingin kembali ke homepage");
            System.out.print("Pilihan(masukkan ID): ");
        ...
        public static void printAktivasiPerangkatUser() {
            while (true) {
                printAsciiBox(logo);
                displaySarusun(0);
                System.out.println("Ketik '.' jika ingin kembali ke homepage");
        ...
        public static void printPendaftaranPerangkat() {
            printAsciiBox(logo);
            displaySarusun(0);
            System.out.println("Ketik '.' jika ingin kembali ke homepage");
        ...
        public static void displaySarusun(int idS) {
            System.out.println();
        ...
        public static void displayAllSarusun(){
            System.out.println();
        ...
        public static void printAsciiBox(String[] text) {
            System.out.println("││-----------------------------------------------------------││");
            int maxLength = 0;
