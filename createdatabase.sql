DROP TABLE IF EXISTS aktivasiPerangkat;
DROP TABLE IF EXISTS logMonitorAir;
DROP TABLE IF EXISTS Pengelola;
DROP TABLE IF EXISTS Perangkat;
DROP TABLE IF EXISTS PemakaianAir;
DROP TABLE IF EXISTS Sarusun;
DROP TABLE IF EXISTS RoleUser;
DROP TABLE IF EXISTS [User];
DROP TABLE IF EXISTS [Role];
DROP TABLE IF EXISTS Tower;
DROP TABLE IF EXISTS LogPengguna;
...
(
	...
	statusAir BIT DEFAULT 0 NOT NULL,
	IdS INT FOREIGN KEY REFERENCES Sarusun (IdS),
	deleted BIT NOT NULL DEFAULT 0
)
